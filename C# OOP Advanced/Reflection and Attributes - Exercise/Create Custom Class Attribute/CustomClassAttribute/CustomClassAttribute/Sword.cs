...
{
    [CustomClass(Author = "Pesho", Revision = 3, Description = "Used for C# OOP Advanced Course - Enumerations and Attributes.", Reviewers = new string[] { "Pesho", "Svetlio" })]
    public class Sword : IWeapon
    {
        ...
        public Sword(string name, string rarity)
        {
            ...
            Rarity = value;
            MinDamage = 4 * (int)value;
            MaxDamage = 6 * (int)value;
