        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventuresEventId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_EventuresEvents_EventuresEventId",
                        column: x => x.EventuresEventId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_EventuresEventId",
                table: "Orders",
                column: "EventuresEventId");
        }
