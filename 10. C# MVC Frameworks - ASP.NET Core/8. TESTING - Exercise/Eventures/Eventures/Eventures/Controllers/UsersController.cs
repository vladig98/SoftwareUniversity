...
namespace Eventures.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(SignInManager<User> signInManager, UserManager<User> userManager,
            IUserStore<User> userStore, ILogger<UsersController> logger, IUsersService usersService)
        {
        ...
        public async Task<IActionResult> Promote(string userId)
        {
            ...
            await _userService.Promote(user);
        ...
        public async Task<IActionResult> Demote(string userId)
        {
            ...
            if (!_userService.HasMoreThanOneAdmin())
            {
                return BadRequest();
            }

            await _userService.Demote(user);

            return Redirect("/Users/Administration");
        }

        [Authorize(Roles = "Admin")]
        public async Task<IActionResult> Administration(int? pageNumber = 1)
        {
            var users = _userService.GetUsers();

            int pageSize = 5;

            var pagedUsers = await PaginatedList<User>.CreateAsync(users, pageNumber ?? 1, pageSize);
        ...
        public async Task<IActionResult> FinishExternalLogin(ExternalLoginViewModel model, string returnUrl = null)
        {
            ...
            {
                User user = _userService.CreateUserInstance(model);
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            ...
            user = _userService.CreateUserInstance(model);
