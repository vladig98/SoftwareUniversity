    ...
    public class StartUp
    {
        public static void Main(string[] args)
        {
            using (SqlConnection connection = new SqlConnection(Config.ConnectionString))
            {
                ...
                string insertIntoCountries = "INSERT INTO Countries ([Name]) VALUES ('Bulgaria'),('England')" +
                    ",('Cyprus'),('Germany'),('Norway')";

                string insertIntoTowns = "INSERT INTO Towns ([Name], CountryCode) VALUES ('Plovdiv', 1)," +
                    "('Varna', 1),('Burgas', 1),('Sofia', 1),('London', 2),('Southampton', 2),('Bath', 2)" +
                    ",('Liverpool', 2),('Berlin', 3),('Frankfurt', 3),('Oslo', 4)";

                string insertIntoMinions = "INSERT INTO Minions (Name,Age, TownId) VALUES('Bob', 42, 3)," +
                    "('Kevin', 1, 1),('Bob ', 32, 6),('Simon', 45, 3),('Cathleen', 11, 2),('Carry ', 50, 10)" +
                ...
                string insertIntoMinionsVillains = "INSERT INTO MinionsVillains (MinionId, VillainId) VALUES " +
